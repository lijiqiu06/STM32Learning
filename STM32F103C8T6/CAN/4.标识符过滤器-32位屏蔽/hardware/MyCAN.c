...
void MyCAN_Init(void)
{
	...
	uint32_t ID=((uint32_t)0x12345600<<3)|0x4;
	uint32_t Mask=((uint32_t)0x1FFFFF00<<3)|0x4;
	CAN_FilterInitStruct.CAN_FilterIdHigh = ID>>16;
	CAN_FilterInitStruct.CAN_FilterIdLow = ID;
	CAN_FilterInitStruct.CAN_FilterMaskIdHigh = Mask>>16;
	CAN_FilterInitStruct.CAN_FilterMaskIdLow = Mask;
