...
CanTxMsg TxMessagearr[]=
{
	...
	{0x000,0x123456AB,CAN_Id_Extended,CAN_RTR_Data,4,{0xAA,0xBB,0xCC,0xDD}},
	{0x000,0x0789ABCC,CAN_Id_Extended,CAN_RTR_Data,4,{0x01,0x30,0x05,0x90}},
	{0x000,0x0789ABEF,CAN_Id_Extended,CAN_RTR_Data,4,{0x10,0x70,0x60,0x08}},
};
